...
const checks = [
  ...
  [app.includes('id="welcome-title"'), "缺少产品进入页核心标题"],
  [app.includes('href="#/home">${icon("spark")}开始创作'), "产品进入页缺少开始创作入口"],
  [app.includes('href="#/editor">${icon("play")}查看完整演示'), "产品进入页缺少匿名演示入口"],
  [app.includes('if (!location.hash) location.hash = "#/welcome"'), "默认入口尚未切换到产品进入页"],
  [css.includes(".welcome-workflow"), "产品进入页缺少五步工作流样式"],
  [css.includes(".welcome-features"), "产品进入页缺少核心能力样式"],
